	...
	(function () {
	  ...
	  document.addEventListener('DOMContentLoaded', function () {
	    singleton.context(function () {
	      ...
	      function newSource(type, init, src) {
	        ...
	        //Frank add
              var youtubesource = src;
              //var youtubesource = 'https://www.youtube.com/watch?v=bylmjy-cA64'

	        switch (type) {

	          case types.youtube:
	              window.alert("youtube@@@")
	            player.source = {
	              type: 'video',
	              sources: [{
	                src: youtubesource,
	      ...
	      if (historySupport) {
	        ...
	        if (video) {
	          currentType = types.youtube;      //Frank:default video type
...
/**
 * Created by luweijia on 2019/1/7.
 */
...
function receiveTest(){
    var type = 3;
    var rece = '{"status":"1", "position":10000, "speed":1.2, "src":"https://www.youtube.com/watch?v=nWb_X3ZJQjw&list=RDnWb_X3ZJQjw&start_radio=1"}'
    console.log("receive json: " + rece);
    var rec_time = new Date() / 1000;
    var rec = rece;
    //logic part
    switch(type) {
...
function stateUpdate(){
    //console.log(player.source.sources.src);
    //setSrc
    if(src_change){
        player.source = {
            type: 'video',
